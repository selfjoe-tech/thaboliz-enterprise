// src/components/products/products-catalog-client.tsx
"use client";
...
function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      rel={product.purchaseMode === "external" ? "noopener noreferrer sponsored" : undefined}
      ...
      <div className="p-4">
        <div className="mb-3 flex flex-wrap items-center gap-2">
          <span className="border border-neutral-300 px-2 py-1 text-[11px] font-medium uppercase tracking-[0.08em] text-neutral-700">
            {product.purchaseMode === "external" ? "External" : "Internal"}
          </span>
...
export default function ProductsCatalogClient({
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [products, selectedCategory, numericMin, numericMax, searchQuery, sortBy]);
