...
const differentSlides = [
  {
    ...
    desc: "Controls are designed around the task, not added later. Reporting, tracking, and issue escalation stay active throughout delivery.",
    image: "/stock/about/pic-13.avif",
  },
  {
    title: "Safety embedded",
    desc: "Controls are designed around the task, not added later. Reporting, tracking, and issue escalation stay active throughout delivery.",
